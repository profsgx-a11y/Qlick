...
export default async function AboutPage({
  ...
  const story: string[] = isEl
    ? [
        ...
        "Κάθε επαγγελματίας αξίζει ένα εργαλείο που είναι γρήγορο, κατανοητό και δίκαιο. Γι' αυτό βάλαμε το QR poster: ο πελάτης σκανάρει, βλέπει διαθεσιμότητα και κλείνει. Χωρίς εφαρμογή, χωρίς τηλέφωνα, χωρίς τριβή.",
