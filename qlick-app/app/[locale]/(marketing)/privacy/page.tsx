    ...
    ? [
        ...
        },
        {
          ...
          body: [
            ...
            "Το event που δημιουργούμε στο ημερολόγιό σου περιέχει τα στοιχεία του ραντεβού: το όνομα του πελάτη και την υπηρεσία στον τίτλο, και στην περιγραφή το τηλέφωνό του μαζί με όποια σημείωση άφησε κατά την κράτηση — δηλαδή όσα χρειάζεσαι για να τον εξυπηρετήσεις. Αυτό σημαίνει ότι τα στοιχεία αυτά αντιγράφονται στον λογαριασμό σου Google και από εκείνο το σημείο διέπονται και από την πολιτική απορρήτου της Google. Αν δεν το επιθυμείς, μη συνδέσεις το ημερολόγιο — ή αποσύνδεσέ το από τις Ρυθμίσεις, οπότε παύουμε να στέλνουμε νέα ραντεβού.",
    ...
    : [
        ...
        },
        {
          ...
          body: [
            ...
            "The event we create in your calendar contains the appointment's details: the customer's name and the service in the title, and in the description their phone number along with any note they left when booking — the information you need in order to serve them. This means those details are copied into your Google account, and from that point they are also governed by Google's privacy policy. If you would rather they were not, do not connect the calendar — or disconnect it from Settings, after which we stop sending new appointments.",
